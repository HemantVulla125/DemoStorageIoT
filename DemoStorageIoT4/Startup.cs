...
namespace DemoStorageIoT4
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFileStorage, FileShareStorage>();
            services.AddScoped<IRecordsTable, RecordStorage>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DemoStorageIoT4", Version = "v1" });
            });
